...
def endprocess():
	...
	window.title("Please give us rating to improve our service: ")

selected = IntVar()

rad1 = Radiobutton(window,text='First class', value=1, variable=selected)

rad2 = Radiobutton(window,text='Second class', value=2, variable=selected)

rad3 = Radiobutton(window,text='Third class', value=3, variable=selected)
